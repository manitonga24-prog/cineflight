# -*- coding: utf-8 -*-
contenu = """package ca.cineflight.stage.control
...
"""
f = r"C:\cineflight_android\CineFlightSolo\app\src\main\java\ca\cineflight\stage\control\Hyperlapse.kt"
import os
if os.path.exists(f):
    print("EXISTE DEJA - non ecrase")
else:
    open(f, "w", encoding="utf-8", newline="\n").write(contenu)
    print("Hyperlapse.kt cree OK")